        ...
        <div class="flex flex-row">
            ...
            <div class="flex items-center px-64">
                <form id="uploadUser" class="flex flex-col w-full px-6  h-auto " action=""
                    ...
                    <div class="w-full">
                        <label for="name" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">UPLOAD
                            DEVICES
                        </label>
                ...
                <div class="pt-6">
                    <button id="uploadUser"
                        class="uploadUser py-2 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
